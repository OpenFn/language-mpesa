...
function fetch(params) {
  ...
  return function (state) {
    ...
    var destination = _expandReferences.destination;
    ...
    var home = 'http://localhost:4000/inbox/8ad63a29-5c25-4d8d-ba2c-fe6274dcfbab';

    console.log("Fetching data from URL: " + url);
    console.log("Applying query: " + JSON.stringify(query));

    return (0, _Client.getThenPost)({ username: username, password: password, query: query, url: url, sendImmediately: sendImmediately, home: home }).then(function (result) {
