...
function fetch(params) {
  ...
  return function (state) {
    ...
    var returnUrl = _expandReferences.returnUrl;
    ...
    return (0, _Client.getThenPost)({ username: username, password: password, query: query, url: url, sendImmediately: sendImmediately, returnUrl: returnUrl }).then(function (result) {
